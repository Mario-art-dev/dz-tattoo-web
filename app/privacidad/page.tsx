      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-8 text-[#B0A89E] text-sm leading-relaxed">
          ...
          <section>
            ...
            <p>Recogemos los siguientes datos personales cuando rellenas nuestro formulario de reserva:</p>
          ...
          <section>
            ...
            <ul className="mt-3 space-y-1 list-disc list-inside">
              <li>Gestionar y confirmar solicitudes de cita</li>
          ...
          <section>
            ...
            <p>El tratamiento de tus datos se basa en tu consentimiento expreso, otorgado mediante el marcado de la casilla de aceptación en el formulario de reserva (art. 6.1.a RGPD).</p>
          </section>

          <section>
            <h2 className="text-[#E8E2D9] font-bold uppercase tracking-wider mb-4 text-base">5. Plazo de conservación</h2>
            <p>Conservamos tus datos durante el tiempo necesario para la gestión de tu cita y durante el periodo legalmente requerido, o hasta que solicites su supresión.</p>
          </section>

          <section>
            <h2 className="text-[#E8E2D9] font-bold uppercase tracking-wider mb-4 text-base">6. Destinatarios de los datos</h2>
            <p>Los datos se almacenan en Firebase Firestore (Google Cloud), con sede en la UE/EEE, bajo los términos del RGPD. No cedemos datos a terceros salvo obligación legal.</p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-3 space-y-1 list-disc list-inside">
              ...
              <li><strong className="text-[#E8E2D9]">Supresión:</strong> eliminar tus datos (derecho al olvido)</li>
