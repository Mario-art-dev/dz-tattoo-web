...
export default function Philosophy() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      gsap.fromTo('.phil-eyebrow', { opacity: 0, y: 10 }, {
      ...
      gsap.fromTo('.phil-card', { opacity: 0, y: 30, scale: 0.96 }, {
        opacity: 1, y: 0, scale: 1, duration: 1.5, stagger: 0.22, ease: 'power3.out',
        scrollTrigger: { trigger: '.phil-grid', start: 'top 82%', toggleActions: 'play none none reset' },
      });
