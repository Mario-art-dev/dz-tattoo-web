...
export default function Services() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.fromTo('.svc-row', { opacity: 0 }, {
        opacity: 1, duration: 1.1, stagger: 0.1, ease: 'power2.out',
        scrollTrigger: { trigger: '.svc-list', start: 'top 84%', toggleActions: 'play none none reset' },
      });
    }, sectionRef);
    return () => ctx.revert();
  }, []);
