...
const gradients = ['from-[#150000] to-[#111111]', 'from-[#0a0a0a] to-[#150000]', 'from-[#111] to-[#0d0000]', 'from-[#0d0000] to-[#0a0a0a]'];
...
export default function Gallery() {
  ...
  return (
    <section id="gallery" ref={sectionRef} className="relative py-20 sm:py-32 lg:py-44 bg-[#111111] border-t border-[#2a2a2a]" aria-label="Galería">
          ...
          {filtered.map((item, i) => (
            ...
            >
              <div className={`relative w-full bg-gradient-to-br ${gradients[i % 4]}`}
                ...
                <div className="absolute inset-0 bg-[#111111]/0 group-hover:bg-[#111111]/35 transition-all duration-400 flex items-center justify-center">
      ...
      {/* Lightbox */}
      {lb && (
        <div ref={lbRef} className="fixed inset-0 z-50 bg-[#111111]/96 backdrop-blur-sm flex items-center justify-center p-4"
          ...
          <div className="relative max-w-3xl max-h-[85vh] w-full" onClick={e => e.stopPropagation()}>
            ...
            <div className="border border-[#111] border-t-0 bg-[#141414] px-6 py-3 flex items-center justify-between">
