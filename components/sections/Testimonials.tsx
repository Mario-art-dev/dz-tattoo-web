...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" ref={sectionRef} className="relative py-32 bg-[#050505] border-t border-[#0f0f0f]" aria-label="Testimonios">
      {/* Grid bg */}
      ...
      <div className="max-w-5xl mx-auto px-6">
        {/* Header */}
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6 mb-16 border-b border-[#111] pb-8 t-reveal">
          <div>
